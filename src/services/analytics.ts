...
export class AnalyticsService {
    ...
    constructor(config: AnalyticsConfig, manifest: chrome.runtime.Manifest, enabled = true) {
      this.config = config;
...
export function trackEvent(category: string, action: string, label: string, value: number | null = null) {
